Please find deployed website at https://kiosk-f7yu.onrender.com/


1. install python 
    - while installing, make sure to select the "add to path" option
2. press windows + R
...
10. To see feedback open "http://localhost:3000/view_feedback"
